...
export class AppointmentController {
	...
	constructor(
		...
		this.router.put("/:id/complete", route(this.handleComplete));
	...
	handleComplete = async (req: Request<GetParams, ExpressSuccessResponse<AppointmentRecord>>, res: Response): Promise<AppointmentRecord> => {
		const { id } = req.params;
		...
		this.nodeCliOutput.print(`[${record.id}] has been completed`);
